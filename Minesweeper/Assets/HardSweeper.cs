...
public class HardSweeper : MonoBehaviour {
	...
	void Awake(){
		...
		options = GameObject.FindGameObjectWithTag ("HardController");
...
//		bDens =  options.GetComponent<MoveOnScript> ().dens;
	...
	public void GameEnd(){
		options.gameObject.GetComponent<HardController> ().newGrid (this.gameObject);
	...
	public void GameLoss(){
		options.gameObject.GetComponent<HardController> ().GameLoss();
